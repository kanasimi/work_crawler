...
var _81xsw = new CeL.work_crawler({
	...
	search_URL : {
		URL : 'http://zhannei.baidu.com/cse/search?'
				+ 's=16095493717575840686&isNeedCheckDomain=1&jump=1&q=',
		charset : 'UTF-8'
	},
	parse_search_result : function(html, get_label) {
		...
		while ((text = get_next_between()) !== undefined) {
			var matched = text.between(null, '"').match(/([\d_]+)\/$/);
